...
create table "groups" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"name" VARCHAR NOT NULL,"description" VARCHAR,"createdAt" TIMESTAMP NOT NULL,"updatedAt" TIMESTAMP NOT NULL);
